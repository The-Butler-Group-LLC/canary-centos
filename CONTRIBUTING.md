# Welcome to the canary-centos10 contributing guide!
...
Once you've cloned the repository and familiarized yourself with our software, if you have a feature request or spot a problem with a component of the code, [search to see if an issue already exists](https://github.com/The-Butler-Group-LLC/canary-centos10/issues). If a related issue doesn't exist, you can open a new issue using the Issues page of this repository.

#### Solve an issue

Scan through our [existing issues](https://github.com/The-Butler-Group-LLC/canary-centos10/issues) to find one that interests you. You can narrow down the search using `labels` as filters. As a general rule, we don’t assign issues to anyone. If you find an issue to work on, you are welcome to open a pull request with a fix.
...
Please reference and adhere to our [pull request template](https://github.com/The-Butler-Group-LLC/canary-centos10/blob/main/.github/PULL_REQUEST_TEMPLATE.md) when filing your pull request. 
...
After review, your pull request will either be approved (in which case congratulations on your contributions :tada::tada:! The canary-centos10 team thanks you :sparkles:), or we'll consult with you about additional changes we believe are needed.
